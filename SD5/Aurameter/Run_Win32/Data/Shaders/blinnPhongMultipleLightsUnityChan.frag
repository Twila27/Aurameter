...
uniform sampler2D uTexDiffuseBody;
uniform sampler2D uTexDiffuseCheek;
uniform sampler2D uTexDiffuseEyeIrisL;
uniform sampler2D uTexDiffuseEyeIrisR;
uniform sampler2D uTexDiffuseEyeline;
uniform sampler2D uTexDiffuseFace;
uniform sampler2D uTexDiffuseHair;
